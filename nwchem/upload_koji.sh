...
timeout --preserve-status --kill-after 10 50 koji build --scratch f36 ~/rpmbuild/SRPMS/nwchem-$NWVER.src.rpm  
timeout --preserve-status --kill-after 10 50 koji build --scratch f37 ~/rpmbuild/SRPMS/nwchem-$NWVER.src.rpm  
